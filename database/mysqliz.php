...
final class mysqliz {
	...
	public function __construct($hostname,$username, $password, $database) {
		$this->mysqli_handler = new mysqli($hostname, $username, $password, $database, 3308);
		
		if ($this->mysqli_handler->connect_error) {
			  trigger_error('Error: Couldd not make a database link (' . $this->mysqli_handler->connect_errno . ') ' . $this->mysqli_handler->connect_error);
			  //backToHome();
		}
		...
		$this->mysqli_handler->query("SET time_zone='+5:30'");
    }
